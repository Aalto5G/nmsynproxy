...
int main(int argc, char **argv)
{
  ...
  sleep(1);
  ldp_set_promisc_mode(dlinq[0]->fd, argv[optind + 0], 1);
  ldp_set_promisc_mode(ulinq[0]->fd, argv[optind + 1], 1);
  ...
  ldp_set_promisc_mode(dlinq[0]->fd, argv[optind + 0], 0);
  ldp_set_promisc_mode(ulinq[0]->fd, argv[optind + 1], 0);
