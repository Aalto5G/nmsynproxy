...
static void three_way_handshake_four_way_fin(void)
{
  ...
  e = synproxy_hash_get(&local, (10<<24)|2, 12345, (11<<24)|1, 54321);
  if (e == NULL)
  {
    log_log(LOG_LEVEL_ERR, "UNIT", "state entry not found");
    exit(1);
...
static void established_rst_uplink(void)
{
  ...
  ip_set_ttl(ip, 64);
  ip_set_proto(ip, 6);
  ip_set_src(ip, (11<<24)|3);
  ip_set_dst(ip, (10<<24)|4);
  ip_set_hdr_cksum_calc(ip, 20);
  tcp = ip_payload(ip);
  tcp_set_src_port(tcp, 54321);
  tcp_set_dst_port(tcp, 12345);
...
static void established_rst_downlink(void)
{
  ...
  ip_set_ttl(ip, 64);
  ip_set_proto(ip, 6);
  ip_set_src(ip, (10<<24)|6);
  ip_set_dst(ip, (11<<24)|5);
  ip_set_hdr_cksum_calc(ip, 20);
  tcp = ip_payload(ip);
  tcp_set_src_port(tcp, 12345);
  tcp_set_dst_port(tcp, 54321);
...
static void three_way_handshake_ulretransmit(void)
{
  ...
  ip_set_ttl(ip, 64);
  ip_set_proto(ip, 6);
  ip_set_src(ip, (10<<24)|10);
  ip_set_dst(ip, (11<<24)|9);
  ip_set_hdr_cksum_calc(ip, 20);
  tcp = ip_payload(ip);
  tcp_set_src_port(tcp, 12345);
  tcp_set_dst_port(tcp, 54321);
  ...
  e = synproxy_hash_get(&local, (10<<24)|10, 12345, (11<<24)|9, 54321);
  if (e == NULL)
  {
    log_log(LOG_LEVEL_ERR, "UNIT", "state entry not found");
    exit(1);
  ...
  ip_set_ttl(ip, 64);
  ip_set_proto(ip, 6);
  ip_set_src(ip, (11<<24)|9);
  ip_set_dst(ip, (10<<24)|10);
  ip_set_hdr_cksum_calc(ip, 20);
  tcp = ip_payload(ip);
  tcp_set_src_port(tcp, 54321);
  tcp_set_dst_port(tcp, 12345);
...
static void three_way_handshake_dlretransmit(void)
{
  ...
  ip_set_ttl(ip, 64);
  ip_set_proto(ip, 6);
  ip_set_src(ip, (10<<24)|12);
  ip_set_dst(ip, (11<<24)|11);
  ip_set_hdr_cksum_calc(ip, 20);
  tcp = ip_payload(ip);
  tcp_set_src_port(tcp, 12345);
  tcp_set_dst_port(tcp, 54321);
  ...
  e = synproxy_hash_get(&local, (10<<24)|12, 12345, (11<<24)|11, 54321);
  if (e == NULL)
  {
    log_log(LOG_LEVEL_ERR, "UNIT", "state entry not found");
    exit(1);
  ...
  ip_set_ttl(ip, 64);
  ip_set_proto(ip, 6);
  ip_set_src(ip, (11<<24)|11);
  ip_set_dst(ip, (10<<24)|12);
  ip_set_hdr_cksum_calc(ip, 20);
  tcp = ip_payload(ip);
  tcp_set_src_port(tcp, 54321);
  tcp_set_dst_port(tcp, 12345);
